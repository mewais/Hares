...
READ_OPS: dict[str, dict] = {
    "read_file": {
        "handler": read_file,
        "description": "Read a single file's contents under the ceiling.",
        "inputSchema": {
            "type": "object",
    ...
    "read_text_file": {
        ...
        "description": "Alias for read_file (mirrors npm filesystem-server).",
        "inputSchema": {
            "type": "object",
            "properties": {"path": {"type": "string"}},
            "required": ["path"],
    ...
    "read_multiple_files": {
        ...
        "description": "Read multiple files in one call. Per-path errors are returned in the result rather than raising.",
        "inputSchema": {
            "type": "object",
    ...
    "list_directory_with_sizes": {
        ...
        "description": "List entries with file sizes.",
        "inputSchema": {
            "type": "object",
            "properties": {"path": {"type": "string"}},
            "required": ["path"],
    ...
    "directory_tree": {
        ...
        "description": "Recursive directory tree as nested JSON.",
        "inputSchema": {
            "type": "object",
            "properties": {"path": {"type": "string"}},
            "required": ["path"],
    ...
    "search_files": {
        ...
        "description": "Search for filenames matching a glob pattern under a directory.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "path": {"type": "string"},
...
WRITE_OPS: dict[str, dict] = {
    ...
    "create_directory": {
        ...
        "description": "Create a directory (and parents). Idempotent.",
        "inputSchema": {
            "type": "object",
            "properties": {"path": {"type": "string"}},
            "required": ["path"],
